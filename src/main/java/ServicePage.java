...
public class ServicePage extends MainPage {
    public ServicePage(WebDriver driver, Actions action) {
        super(driver, action);
    }
    ...
    public ServicePage clickpreviousslide2(int previosnum){
    ...
    public ServicePage clicknextslide2(int nextnum){
    ...
    public ServicePage clickpreviousslide1(int previosnum){
        for (int i = 0; i < previosnum; i++) {
    ...
    public ServicePage clicknextslide1(int nextnum){
        for (int i = 0; i < nextnum; i++){
