...
public class PermanentPage extends MainPage {

    public PermanentPage(WebDriver driver, Actions action) {
        super(driver, action);
    }
    ...
    public PermanentPage clickpreviousslide2(int previosnum){
    ...
    public PermanentPage clicknextslide2(int nextnum){
    ...
    public PermanentPage clickpreviousslide1(int previosnum){
        for (int i = 0; i < previosnum; i++) {
    ...
    public PermanentPage clicknextslide1(int nextnum){
        for (int i = 0; i < nextnum; i++){
